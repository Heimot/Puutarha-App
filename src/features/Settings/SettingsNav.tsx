...
const adminData = [
    { icon: <AccountCircleIcon />, label: 'Muokkaa käyttäjiä', id: 'users' },
    { icon: <RememberMeIcon />, label: 'Muokkaa rooleja', id: 'roles' },
    { icon: <TuneIcon />, label: 'RFID', id: 'rfid' },
    { icon: <InventoryIcon />, label: 'Muokkaa tuotteen tiloja', id: 'state' },
    { icon: <PrecisionManufacturingIcon />, label: 'Muokkaa tilauksen tiloja', id: 'status' },
    { icon: <ExploreIcon />, label: 'Muokkaa keräyspaikkoja', id: 'location' },
    { icon: <SearchIcon />, label: 'Muokkaa kauppoja ja kukkia', id: 'autofill' },
    { icon: <LabelIcon />, label: 'Muokkaa tarroja', id: 'stickers' },
    { icon: <ListAltIcon />, label: 'Logit', id: 'logs' },
];
